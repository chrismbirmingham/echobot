...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        while True:
            ...
            # text = transcriber.process_data(data)
            print("data recieved")

            if start:
                transcriber.process_first_data(data)
                start=False
            else:
                transcriber.process_data(data)


            if transcriber.segment_ended:
                await websocket.send_text(transcriber.transcribe())
